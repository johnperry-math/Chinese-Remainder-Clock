...
public class CRC_View_Shady extends Clock_Drawer {
  ...
  /**
   *
   * This sets up arrays of floats that are used as both references for drawLines() and
   * to build Paths for the polygons, which draw() then paints and fills accordingly.
   * The use of Paths improves efficiency.
   * @see Path
  ...
  void recalculate_positions() {
    ...
    // set up points for Paths and lines
    ...
    // now set up the paths, using the points we just created
